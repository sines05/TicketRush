...
- **Python AI Agent**:
  ...
  - [Psycopg / PostgresSaver](https://github.com/langchain-ai/langgraph): Lưu trữ lịch sử hội thoại (checkpoint) bền vững vào PostgreSQL.
...
Tài liệu này bao phủ toàn bộ cơ chế cốt lõi và các câu hỏi bảo vệ đồ án trực diện nhất của hệ thống TicketRush. Nhóm phát triển có thể tự tin sử dụng bộ câu hỏi này để trả lời nhanh, dứt khoát và chính xác trước hội đồng phản biện.
