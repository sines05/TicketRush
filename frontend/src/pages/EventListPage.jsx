...
import { Calendar, MapPin, Ticket as TicketIcon, Search, Loader2 } from 'lucide-react';
...
const EventListPage = () => {
  ...
  const { data: events, isLoading, isFetching, error } = useQuery({
    ...
    queryFn: async () => {
      return await api.get(debouncedSearch ? `/events?q=${debouncedSearch}` : '/events');
    },
  });
  ...
  return (
    <div>
      <header className="text-center mb-12">
        ...
        <p className="text-gray-600 mb-8">Grab your tickets for the most anticipated shows!</p>
        ...
        <div className="max-w-xl mx-auto relative">
          ...
          <input
            type="text"
            placeholder="Search events (e.g. Son Tung, Rap Viet...)"
      ...
      {isLoading && !events ? (
        ...
        <div className="text-center py-20 text-gray-400">No events found matching "{debouncedSearch}"</div>
      ) : (
