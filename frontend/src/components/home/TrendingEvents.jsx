...
export default function TrendingEvents() {
  ...
  return (
    <section className="space-y-8 group/section" aria-labelledby="home-trending-events-heading">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="text-3xl" aria-hidden="true">🔥</span>
          <h2 id="home-trending-events-heading" className="text-2xl font-bold tracking-tight text-foreground uppercase italic">Sự kiện xu hướng</h2>
        </div>
        ...
        >
          {items.map((evt, idx) => {
            ...
            return (
              ...
              >
                {/* Ranking Number */}
                <span className="text-7xl md:text-8xl font-black text-teal-400 italic opacity-80 select-none -mr-4 md:-mr-6 z-10 drop-shadow-[0_4px_8px_rgba(45,212,191,0.4)]" aria-hidden="true">
                  {rank}
                </span>
